...
<center>
    ...
    <div id="site">
            ...
            <button  class="mybtn"  id="btn-ej3">EJEMPLO</button>
            <div id="ej3" class="ej">
            ...
            <button  class="mybtn" id="btn-ej4">EJEMPLO</button>
            <div id="ej4" class="ej">
